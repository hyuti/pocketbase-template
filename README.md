...
Change [docs.go](https://github.com/hyuti/pocketbase-template/blob/master/docs/docs.go)

```go
package docs

import _ "github.com/hyuti/pocketbase-template/docs/v3" // replace this
// import _ "github.com/hyuti/pocketbase-template/docs/v2"
```
